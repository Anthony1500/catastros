...
$gdImage = imagecreatefrompng('imagenes/logo.png');//Logotipo
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
$sql1 = "SELECT * FROM propietario";
	$resultado1 = mysqli_query($con,$sql);
$fila1 = 24; //Establecemos en que fila inciara a imprimir los datos
$gdImage = imagecreatefrompng('imagenes/logo.png');//Logotipo	
	//Objeto de PHPExcel
	$objPHPExcel  = new PHPExcel();
	
	//Propiedades de Documento
	$objPHPExcel->getProperties()->setCreator("Anthony")->setDescription("Reporte de Propietario");
	...
	$estiloTituloReporte = array(
		...
		$objPHPExcel->getActiveSheet()->setCellValue('D3', 'REPORTE DE PROPIETARIO');
